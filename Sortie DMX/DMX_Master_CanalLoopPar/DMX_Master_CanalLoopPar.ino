...
void loop() 
{
  ...
  // Red
  for (dimmer_val = 0; dimmer_val <= 100; dimmer_val++) {
  ...
  // Green
  for (dimmer_val = 0; dimmer_val <= 100; dimmer_val++) {
    dmx_master.setChannelValue (3, dimmer_val);
    delay (100);
  }
  dmx_master.setChannelValue (3, 0);
  // Blue
  for (dimmer_val = 0; dimmer_val <= 100; dimmer_val++) {
    dmx_master.setChannelValue (4, dimmer_val);
    delay (100);
  }
...
void clignotantW ()
{
  dmx_master.setChannelValue (5, 100);
  delay (50);
  dmx_master.setChannelValue (5, 0);
  delay (50);
}
